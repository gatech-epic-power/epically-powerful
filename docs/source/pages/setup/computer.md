...
2.  To enable actuator communication, solder the 4 CAN communication pin holes in the Jetson's carrier board with 90° male-to-male pins.
    ...
    - Third, raise up the side of the board with the bolt holes, then gently pull the board away from the carrier board slot that it is plugged into, shown as (3) in image below.
